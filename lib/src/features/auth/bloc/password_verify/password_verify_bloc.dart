...
class PasswordVerifyBloc
    extends Bloc<PasswordVerifyEvent, PasswordVerifyState> {
  ...
  Future<void> _passwordVerify(PasswordVerify$PasswordVerifyEvent event,
      Emitter<PasswordVerifyState> emit) async {
    ...
    try {
      ...
      if (result["success"] as bool && event.context.mounted) {
        await event.context.dependencies.shp
            .setString(Constants.token5, result["data"] as String);
